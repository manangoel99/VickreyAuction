...
contract('Test for Vickery Auction', async accounts => {
    ...
    it("Highest Bid", async () => {
        ...
        assert.equal(val[0].valueOf(), accounts[2], "Wrong high bidder");
        assert.equal(val[1].valueOf(), 20, "Wrong second bid");
        ...
        assert.equal(bal4[1].valueOf(), 20, "Wrong contract balance");
    });
