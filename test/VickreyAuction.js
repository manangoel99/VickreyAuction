...
contract('Test for Vickery Auction', async (accounts) => {
    ...
    it("Highest Bid", async () => {
		...
		await instance.reveal.call(10, 10, {from: accounts[1], gas: 3000000});
		await instance.reveal.call(20, 10, {from: accounts[2], gas: 3000000});
		await instance.reveal.call(40, 10, {from: accounts[3], gas: 3000000});
